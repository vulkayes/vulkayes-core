...
use ash::vk::{DeviceQueueCreateFlags, DeviceQueueInfo2};
...
impl Queue {
	...
	pub unsafe fn from_device(device: Vrc<Device>, flags: DeviceQueueCreateFlags, queue_family_index: u32, queue_index: u32) -> Self {
