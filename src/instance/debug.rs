...
impl Default for DebugCallback {
	fn default() -> Self { DebugCallback::None() }
}
...
unsafe extern "system" fn default_debug_callback(
	flags: DebugReportFlagsEXT, object_type: DebugReportObjectTypeEXT, object: u64,
	location: usize, message_code: i32, p_layer_prefix: *const c_char, p_message: *const c_char,
	_p_user_data: *mut c_void
) -> Bool32 {
	let perf_optional =
		if flags == DebugReportFlagsEXT::PERFORMANCE_WARNING { "{PERF} " } else { "" };
